## 👨‍💻 이강엽 (Kang Yub Lee)
로봇 설계 및 제어 시스템 개발 전문가로, 특수 환경용 로봇 개발과 ROS2 기반 임베디드 시스템 구현에 2년 이상의 경험을 보유하고 있습니다. 로프 등강 로봇, 모바일 앵커 로봇 등 비정형 환경에서 작동하는 로봇 플랫폼을 개발했으며, 진동 제어 알고리즘 및 하드웨어-소프트웨어 통합 시스템 설계에 전문성을 갖추고 있습니다.
...
- **성과**:
  - 비정형 형상 건물에 **적용 가능한 로봇 시스템을 개발**하여 기존 방식 대비 **작업 영역을 확장**
  - 개발한 로봇 플랫폼으로 **고척 스카이돔 현장 테스트** 진행
  - **2023, 2024 로보월드 전시회**에서 기술 시연 
- **기술적 성과**:
  - 로프와 Wheel-Leg 메커니즘을 융합하여 **고경사 장애물을 효과적으로 극복**
  - ROS2 기반 제어 시스템 구현으로 **실시간 로봇 구동 및 진동 제어** 
- **개발 시스템**:
  - **DAR (Dual Ascending Robot)**: 곡면 환경에서 로프등강 이동 플랫폼 진동 제어
  - **RDWR (Rope Driven Wheel-Leg Robot)**: 4족 휠레그 구조로 외벽 장애물 극복 능력 향상
  - **RMA (Rope-Riding Mobile Anchor)**: 작업 영역 확장용 이동식 앵커 포인트 로봇 개발
...
- **상세 기술**:
  ...
  - MATLAB/Simulink 활용한 시스템 시뮬레이션 수행
  - CAD 활용한 **전체 로봇 하드웨어** 설계 및 개발 
  - MCU 프로그래밍, 통신 구현 등을 통한 **전장부 설계**
  - **ROS2 기반 임베디드 시스템**으로 로봇 실시간 진동 제어 구현
